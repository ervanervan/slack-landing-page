...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "px-6 py-2.5 w-full lg:w-fit rounded-[14px] font-bold text-sm md:text-base md:text-lg transition-all duration-200 flex items-center justify-center gap-1.5";
