      ...
      <div className="flex flex-col items-center justify-center">
        <div className="relative">
          ...
          <StatButton
            ...
            count={12}
            size="xlarge"
            className="absolute -top-4 hidden lg:inline-flex lg:-left-28"
          />
          <StatButton
            icon={<BriefcaseIcon size={18} />}
            count={30}
            size="medium"
            className="absolute top-12 hidden lg:inline-flex lg:-left-40"
          />
          <StatButton
            icon={<ChartIcon size={18} />}
            count={27}
            size="medium"
            className="absolute -bottom-4 hidden lg:inline-flex lg:-left-28"
          />
          <StatButton
            icon={<FlexedBicepsIcon size={16} />}
            count={27}
            size="small"
            className="absolute -top-4 hidden lg:inline-flex lg:-right-32"
          />
          <StatButton
            icon={<RedHeartIcon size={22} />}
            count={42}
            size="large"
            className="absolute top-11 hidden lg:inline-flex lg:-right-28"
          />
          <StatButton
            icon={<LoveYouIcon size={18} />}
            count={18}
            size="medium"
            className="absolute -bottom-4 hidden lg:inline-flex lg:-right-40"
          />
        </div>
